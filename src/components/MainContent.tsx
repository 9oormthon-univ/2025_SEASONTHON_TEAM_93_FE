          ...
          <div className="content-card">
            ...
            <div className="card-content">
              ...
              <p className="card-description">
                (간단한 내용 들어갈 곳)Faucibus sit eu magna dui turpis facilisis tincidunt purus vel. 
                Venenatis lorem turpis nullam id mauris vel dignissim. Pharetra ac sit ullamcorper
              </p>
            </div>
          </div>
